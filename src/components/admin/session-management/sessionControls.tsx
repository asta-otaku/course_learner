...
const STATUS_OPTIONS = [
  ...
  { value: SessionStatus.AVAILABLE, label: "Available" },
  { value: SessionStatus.PENDING, label: "Pending" },
  { value: SessionStatus.CONFIRMED, label: "Confirmed" },
    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border mb-6">
      <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-medium text-gray-900">Session Filters</h3>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="md:col-span-3">
          ...
          <Input
            type="text"
            placeholder="Search by session name, tutor, or student..."
