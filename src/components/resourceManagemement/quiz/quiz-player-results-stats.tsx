...
export function QuizPlayerResultsStats({
  ...
  const finalScore = `${Math.round(submissionResults.score)}/${Math.round(
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-blue-900">{finalScore}</p>
        </div>
      </div>
      <div className="flex items-center gap-3 p-4 bg-green-50 rounded-lg border border-green-200">
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-green-900">{roundedPercentage}</p>
        </div>
      </div>
