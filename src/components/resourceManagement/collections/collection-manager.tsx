...
import {
  ...
  usePutCollection,
  useDeleteCollection,
  usePostCollectionQuestion,
  useDeleteCollectionQuestion,
  usePatchReorderCollectionQuestions,
...
export function CollectionManager({
  ...
  const createCollectionMutation = usePostCollection();
  const updateCollectionMutation = usePutCollection();
  const deleteCollectionMutation = useDeleteCollection();
  const addQuestionMutation = usePostCollectionQuestion();
  const removeQuestionMutation = useDeleteCollectionQuestion();
  const reorderQuestionsMutation = usePatchReorderCollectionQuestions();
    ...
    async (id: string) => {
      startTransition(async () => {
        try {
          ...
          toast({
            title: "Error",
            description: getErrorMessage(error, "Failed to delete collection"),
            variant: "destructive",
          });
        }
      });
    },
    [selectedCollection, router, toast, onRefresh, deleteCollectionMutation]
  );
  ...
  const handleSave = useCallback(async () => {
    startTransition(async () => {
      try {
        ...
        toast({
          title: "Error",
          description: getErrorMessage(error, "Failed to save collection"),
          variant: "destructive",
        });
      }
    });
  ...
  const handleQuestionDrop = useCallback(
    async (collectionId: string, data: { questionId?: string }) => {
      ...
      startTransition(async () => {
        try {
          ...
          toast({
            title: "Error",
            description: getErrorMessage(error, "Failed to add question"),
            variant: "destructive",
          });
        }
      });
    },
    [toast, onRefresh, addQuestionMutation]
  );
    ...
    async (questionId: string) => {
      ...
      startTransition(async () => {
        try {
          ...
          toast({
            title: "Error",
            description: getErrorMessage(error, "Failed to remove question"),
            variant: "destructive",
          });
        }
      });
    },
    [selectedCollection, toast, onRefresh, removeQuestionMutation]
  );
    ...
    async (event: any) => {
      ...
      startTransition(async () => {
        try {
          ...
          toast({
            title: "Error",
            description: getErrorMessage(error, "Failed to reorder questions"),
            variant: "destructive",
          });
        }
      });
    },
    [selectedCollection, toast, onRefresh, reorderQuestionsMutation]
  );
