...
export function ImageUpload({
  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- uploadFile closes over latest onUpload/onError
  }, []);
  ...
  const handlePaste = useCallback(
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- paste uses latest uploadFile
    [onError]
  );
