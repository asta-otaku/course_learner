...
import { MultipleChoiceEditor } from "@/components/resourceManagement/questions";
import { TrueFalseEditor } from "@/components/resourceManagement/questions";
import { FreeTextEditor } from "@/components/resourceManagement/questions";
import { MatchingEditor } from "@/components/resourceManagement/questions";
...
export function UniversalQuestionEditor({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- validate when the question object changes
  }, [question]);
