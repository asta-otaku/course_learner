...
import { Plus, Folder, ChevronsUpDown, Check } from "lucide-react";
...
export function FolderSelect({
  ...
  const { data: foldersResult, isLoading: _isLoadingFolders } = useGetFolders();
  ...
  const handleCreateFolder = async () => {
    ...
    try {
      ...
      if (result.status === 200 || result.status === 201) {
        ...
        const created = result.data as { id?: string; data?: { id: string } };
