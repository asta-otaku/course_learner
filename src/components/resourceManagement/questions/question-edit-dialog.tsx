...
type QuestionFormState = {
  ...
  acceptedAnswers?: Array<{ content?: string; gradingCriteria?: string }>;
...
export function QuestionEditDialog({
  ...
  const handleTypeSpecificChange = (typeData: object) => {
    setFormData((prev: QuestionFormState) => ({ ...prev, ...typeData }));
  };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      formDataToSend.append("type", formData.type || "multiple_choice");
      ...
      formDataToSend.append(
        ...
        formData.metadata?.correctFeedback
          ? String(formData.metadata.correctFeedback)
          : "",
      );
      formDataToSend.append(
        "incorrectFeedback",
        formData.metadata?.incorrectFeedback
          ? String(formData.metadata.incorrectFeedback)
          : "",
      );
      ...
      if (
        ...
        formDataToSend.append(
          "acceptedAnswers",
          JSON.stringify(
            (formData.acceptedAnswers || []).map((answer) => ({
              content: answer.content || "",
        ...
        formDataToSend.append(
          "matchingPairs",
          JSON.stringify(
            (formData.matchingPairs || []).map((pair) => ({
              left: pair.left || "",
              right: pair.right || "",
            }))
          )
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              {(formData.answers || questionData.answers || []).map(
                (answer: QuestionFormAnswer, index: number) => (
                    ...
                    <input
                      ...
                      onChange={() => {
                        const newAnswers = (
                          ...
                          []
                        ).map((a: QuestionFormAnswer, i: number) => ({
                          ...a,
                          isCorrect: i === index,
                        }));
                        setFormData((prev: QuestionFormState) => ({
                          ...prev,
                          answers: newAnswers,
                        }));
                      }}
              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value: QuestionType) =>
                        setFormData((prev: QuestionFormState) => ({ ...prev, type: value as any }))
                      }
                    >
                  ...
                  {formData.image_url ? (
                    <div className="relative">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          setFormData((prev: QuestionFormState) => ({ ...prev, image_url: null }))
                        }
                      >
                        <X className="h-4 w-4" />
                      </Button>
                    ...
                    <ImageUpload
                      onUpload={(url) =>
                        setFormData((prev: QuestionFormState) => ({ ...prev, image_url: url }))
                      }
                      onError={(error) =>
                        toast({
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    value={formData.hint || ""}
                    onChange={(e) =>
                      setFormData((prev: QuestionFormState) => ({ ...prev, hint: e.target.value }))
                    }
